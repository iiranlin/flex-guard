  ...
  const successCases: SuccessCase[] = [
    ...
    },
    {
      ...
      detail: {
        ...
        problem: "公司以'家政行业特殊性'为由拒绝签订劳动合同，刘阿姨担心年龄大了找不到工作，一直忍气吞声。直到2025年7月，公司突然通知要降低工资，刘阿姨才决定维权。",
    ...
    },
    {
      ...
      date: "2025-08-15",
      detail: {
        background: "张师傅在某外卖平台工作了8个月，每月收入约4000-5000元。2025年8月，站点以各种理由推迟发放7月份工资，总计拖欠3500元。",
    ...
    },
    {
      ...
      date: "2025-09-08",
      detail: {
        background: "李师傅是一名网约车司机，在平台工作3年，服务评分一直保持在4.9分以上。2025年9月底，因一名乘客的恶意投诉（声称司机绕路），账号被平台封禁7天。",
    ...
    },
    {
      ...
      date: "2025-10-20",
      detail: {
        background: "王女士在某物流公司从事夜班包裹分拣工作已6个月，虽然没有签订正式劳动合同，但每天按时打卡上下班。2025年10月，在工作时因地面湿滑摔伤，导致左手腕骨折。",
    ...
    },
    {
      ...
      date: "2025-11-28",
      detail: {
        background: "陈师傅在某快递公司工作2年，主要负责户外配送工作。2025年7-9月，当地气温多次超过35℃，但公司一直未按规定发放高温津贴。",
        ...
        result: "劳动仲裁委员会支持了陈师傅的诉求，裁定公司补发2025年7-9月的高温津贴共计1800元，并要求公司按规定为所有户外工作人员发放高温津贴。",
        duration: "30天",
  ...
  const policies: Policy[] = [
    {
      ...
      content: {
        introduction: "为依法保护新就业形态劳动者合法权益，规范网络平台用工行为，最高人民法院于2025年8月发布了《关于审理网络平台用工纠纷案件适用法律若干问题的解释》。该解释针对外卖配送、网约车、快递等新就业形态的特点，明确了劳动关系认定的具体标准，为劳动者维权提供了更加清晰的法律依据。",
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        introduction: "2025年9月，人力资源社会保障部、国家发展改革委、交通运输部、应急管理部、市场监管总局、国家医保局、最高人民法院、全国总工会等八部门联合发布了《关于维护新就业形态劳动者劳动保障权益的指导意见（修订版）》。这是在2025年7月首版意见基础上的全面升级，针对新出现的问题和实践需求，进一步细化和强化了保障措施。",
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        introduction: "2025年10月，中华全国总工会印发《关于加强新就业形态劳动者工会工作的意见》，明确提出要破除体制机制障碍，创新组织形式和服务方式，最大限度把新就业形态劳动者吸收到工会组织中来，切实维护其合法权益。",
        keyPoints: [
        ...
        impact: "工会组织的积极介入将为新就业形态劳动者提供强有力的组织保障。截至2025年12月，全国已有超过3000万新就业形态劳动者加入工会，各地成立了500余个新就业形态行业工会。通过工会的法律援助，数万名劳动者成功维护了自身权益；通过集体协商，多家平台企业提高了劳动者的收入水平和福利待遇；通过技能培训，帮助劳动者提升了就业竞争力。",
        references: [
          "《中华人民共和国工会法》",
    ...
    },
    {
      ...
      content: {
        introduction: "为进一步完善灵活就业人员社会保险制度，人力资源社会保障部于2025年11月发布了《灵活就业人员社会保险参保指南》，详细规定了参保条件、缴费标准、待遇享受等内容，旨在让更多灵活就业人员享受社会保险保障。",
        keyPoints: [
        ...
        impact: "本指南的发布大大降低了灵活就业人员的参保门槛，提高了参保的灵活性和便利性。数据显示，2025年下半年，全国灵活就业人员参保人数增加了800万，参保率提升了15个百分点。灵活的缴费方式使更多低收入劳动者能够负担社保费用；政府补贴政策惠及200余万就业困难人员；跨地区转移接续机制解决了流动性强的灵活就业人员的后顾之忧。",
        references: [
          "《中华人民共和国社会保险法》",
